...
namespace Day_6_Interfaces
{
    ...
    // Since it is a type of Card Hand will use the ICardHnd interface 
    ...
    public class PokerHand : ICardHand
    {
        ...
        private const int INITIAL_NUMBER_CARDS_IN_HAND = 5;
        private const int MAX_NUMBER_CARDS_IN_HAND     = 5;
