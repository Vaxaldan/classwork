...
{
    public class ThreeCardPokerHand : ICardHand
    {
        /**********************************************************
         * Data Members
         *********************************************************/
        ...
        private const int INITIAL_NUMBER_CARDS_IN_HAND = 3;
        private const int MAX_NUMBER_CARDS_IN_HAND     = 3;
